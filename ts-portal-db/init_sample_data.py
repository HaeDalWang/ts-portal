...
def create_sample_data():
    ...
    try:
        ...
        notices = [
            Notice(
                title="🚨 [중요] 2025년 하반기 AWS 인증 취득 계획",
                content="""안녕하세요, TS팀 여러분!

2025년 하반기 AWS 인증 취득 계획을 공유드립니다.
...
관심 있는 분들은 파트장님께 말씀해 주세요!""",
            ...
            Notice(
                title="⚠️ [주의] 여름 휴가 일정 조율 안내",
                content="""여름 휴가 일정 조율 관련 안내드립니다.

📅 **휴가 신청 기간**: 6월 20일 ~ 7월 5일
🏖️ **휴가 사용 기간**: 7월 15일 ~ 8월 31일

**주의사항**
- 파트별 최소 인원 유지 필요
- 고객사 일정과 겹치지 않도록 사전 확인
- 2주 이상 연속 휴가 시 사전 협의 필수
...
궁금한 점은 언제든 문의해 주세요!""",
            ...
            Notice(
                title="📢 새로운 팀원 김이현님 환영합니다!",
                content="""안녕하세요!

Leaf 파트에 새로 합류하신 김이현님을 소개합니다.

👤 **프로필**
- 이름: 김이현
- 포지션: 주임
- 전문분야: Frontend, Vue.js, React, TypeScript
- 입사일: 2023년 6월 1일

프론트엔드 개발 경험이 풍부하신 분으로, 앞으로 TS Portal 개발에 큰 도움이 될 것 같습니다.
...
많은 관심과 응원 부탁드립니다! 🎉""",
            ...
            Notice(
                title="🔧 EKS 클러스터 업그레이드 완료",
                content="""EKS 클러스터 업그레이드 작업이 완료되었습니다.

🔄 **업그레이드 내용**
- Kubernetes 버전: 1.28 → 1.29
- 업그레이드 일시: 2025년 6월 10일 02:00-04:00
- 영향 범위: 개발/스테이징 환경
...
혹시 이상 사항 발견 시 즉시 알려주세요!""",
            ...
            Notice(
                title="📊 Q2 성과 발표 자료 제출 안내",
                content="""Q2 성과 발표 자료 제출 관련 안내입니다.

📅 **제출 일정**
- 제출 마감: 7월 20일 (금) 18:00
- 발표 일정: 7월 25일 (화) 14:00-17:00
...
📧 **제출 방법**: 이메일로 PPT 파일 제출
📧 **제출처**: ham.inyong@saltware.co.kr
...
많은 참여 부탁드립니다!""",
            ...
            Notice(
                title="🎓 AWS Summit Korea 2025 참가 후기",
                content="""AWS Summit Korea 2025 참가 후기를 공유드립니다.
...
🎯 **주요 세션**
1. "Generative AI on AWS" - 생성형 AI 서비스 소개
2. "EKS Best Practices" - 컨테이너 운영 최적화
3. "FinOps for Cloud Cost Optimization" - 비용 최적화 전략
...
자세한 내용은 팀 회의에서 공유하겠습니다!""",
            ...
            Notice(
                title="🔒 보안 패치 적용 완료 안내",
                content="""보안 패치 적용이 완료되었습니다.
...
지속적인 보안 관리를 위해 노력하겠습니다.""",
            ...
            Notice(
                title="📈 Kubecost 도입으로 비용 가시성 향상",
                content="""Kubecost 도입을 통한 비용 가시성 개선 소식을 전해드립니다.
...
🔗 **접속 방법**: 내부 모니터링 포털 > Kubecost 메뉴

팀 전체의 비용 의식 향상에 도움이 될 것 같습니다!""",
                priority=NoticePriority.NORMAL,
        ...
        db.commit()
        print(f"✅ {len(notices)}개 공지사항 데이터 생성 완료")
        ...
        print("   - 공지사항: http://localhost:8001/notices/")
